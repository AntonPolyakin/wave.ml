...
<body>
            ...
            <div class="overflow-container">
                ...
                <ul class="sub-menu-dropdown menu-artists menu-dropdown hided">
                    <li>
                        ...
                        <span class="icon circle-image" style="background:rgba(0, 0, 0, 0);border: 2px solid;">
                            <i class="fas fa-plus"></i>
                        </span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="icon circle-image" style="background-image:url('https://lastfm-img2.akamaized.net/i/u/300x300/774177d77ee348e198bee6d223a22ff3.png')">
                        </span>
                    </li>
    ...
    <div class="new-wrapper">
        ...
        <div id="main">
            ...
            <div id="tab-container">
                ...
                <div class="tab-content greeting" data-tabcontent="search">
                    ...
                    <div class="search-content">
                        ...
                        <div class="page-block_container">
                            <div class="page_block artist">
                                <div class="page_block__title">
                                    Artists
                                </div>
                        ...
                        <div class="search-tabs">
                            <input type="radio" name="tabs" id="music-results" checked="checked">
                            <label for="music-results" class="tab-title music">Music</label>
                            <div class="tab">
                            ...
                            <input type="radio" name="tabs" id="playlist-results">
                            <label for="playlist-results" class="tab-title playlist">Playlists</label>
                            <div class="tab">
    ...
    <div class="meeting-block">
                ...
                <div class="tab-content" data-tabcontent="library">
                    ...
                    <!--slider-->
                    <div class="slider-main" id='slider__library'>
                        <button class="slider-leftBtn slider-arrow"><i class="fal fa-chevron-left"></i></button>
                        <button class="slider-rightBtn slider-arrow"><i class="fal fa-chevron-right"></i></button>
                        <ul class="slider-container">
                            <li class="slider-container__first">start</li>
                    ...
                    <ul class="filter-block album" data-playlist="library">
                        <li>
                            <div class="cover-image" style="background-image:url(https://upload.wikimedia.org/wikipedia/en/thumb/5/50/Sgt._Pepper%27s_Lonely_Hearts_Club_Band.jpg/220px-Sgt._Pepper%27s_Lonely_Hearts_Club_Band.jpg)">
                                <span class="play-button"></span>
                            </div>
